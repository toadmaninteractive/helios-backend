...
to_binary(Binary) when is_binary(Binary) -> to_utf8_binary(Binary);
to_binary(String) when is_list(String) -> to_utf8_binary(String);
...
to_utf8_binary(String) when is_list(String) ->
    to_utf8_binary(list_to_binary(String));
to_utf8_binary(Raw) when is_binary(Raw) ->
    case unicode:characters_to_binary(Raw) of

...
-module(web_rest_auth_personnel_api_key).
...
-export([
    init/2,
    regenerate_personnel_api_key_403/1
]).
...
regenerate_personnel_api_key_403(ResponseContent403) ->
...
handle_put(Req) ->
    try
        ...
        {ResponseContent, Req2} = web_rest_callback_personnel:regenerate_personnel_api_key(RequestContent, Req1),
        Body = jsx:encode(web_protocol:personnel_api_key_update_response_to_json(ResponseContent)),

...
handle_post(Req) ->
    try
        ...
        RequestContent = web_protocol:personnel_login_request_from_json(jsx:decode(RequestBody, [return_maps])),
        {ResponseContent, Req2} = web_rest_callback_personnel:login_personnel(RequestContent, Req1),
        Body = jsx:encode(web_protocol:personnel_login_response_to_json(ResponseContent)),

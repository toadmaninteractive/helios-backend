...
get_game_change_logs_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_game:get_game_change_logs(Guid, Branch, Search, Offset, Limit, Req),
        Body = jsx:encode(web_protocol:collection_slice_to_json(ResponseContent, {custom, fun web_protocol:change_log_to_json/1})),

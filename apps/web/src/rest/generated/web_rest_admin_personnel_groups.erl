...
-module(web_rest_admin_personnel_groups).
...
get_personnel_groups_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        OrderBy = igor_http:parse_query(<<"order_by">>, Qs, {custom, fun web_protocol:personnel_group_order_by_from_string/1}),
        ...
        {ResponseContent, Req1} = web_rest_callback_admin_personnel_group:get_personnel_groups(Needle, OrderBy, OrderDir, Offset, Limit, Req),
        Body = jsx:encode(web_protocol:collection_slice_to_json(ResponseContent, {custom, fun web_protocol:personnel_group_to_json/1})),

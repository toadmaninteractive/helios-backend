...
-module(web_rest_admin_builds_game).
...
get_builds_for_game_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_admin_build:get_builds_for_game(Guid, OrderBy, OrderDir, Offset, Limit, Req),

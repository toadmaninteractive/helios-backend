...
-module(web_rest_admin_game_roles_account).
...
-export([
    init/2,
    get_personnel_account_roles_for_game_403/1
]).
...
get_personnel_account_roles_for_game_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        OrderBy = igor_http:parse_query(<<"order_by">>, Qs, {custom, fun web_protocol:personnel_account_role_order_by_from_string/1}),
        ...
        {ResponseContent, Req1} = web_rest_callback_admin_personnel_roles:get_personnel_account_roles_for_game(Guid, Needle, OrderBy, OrderDir, Offset, Limit, Req),
        Body = jsx:encode(web_protocol:collection_slice_to_json(ResponseContent, {custom, fun web_protocol:personnel_account_role_to_json/1})),

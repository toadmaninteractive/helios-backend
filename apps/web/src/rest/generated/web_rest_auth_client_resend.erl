...
-module(web_rest_auth_client_resend).
...
handle_post(Req) ->
    try
        ...
        RequestContent = web_protocol:client_resend_request_from_json(jsx:decode(RequestBody, [return_maps])),
        {ResponseContent, Req2} = web_rest_callback_client:resend_registration_code(RequestContent, Req1),

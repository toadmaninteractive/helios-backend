...
-module(web_rest_auth_personnel_status).
...
handle_get(Req) ->
    try
        {ResponseContent, Req1} = web_rest_callback_personnel:get_personnel_status(Req),
        Body = jsx:encode(web_protocol:personnel_status_response_to_json(ResponseContent)),

...
-module(web_rest_admin_personnel_my_roles).
...
-export([
    init/2,
    get_my_personnel_account_roles_403/1
]).
...
get_my_personnel_account_roles_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_admin_personnel_roles:get_my_personnel_account_roles(Needle, OrderBy, OrderDir, Offset, Limit, Req),

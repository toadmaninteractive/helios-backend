...
get_builds_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        ActiveOnly = igor_http:parse_query(<<"active_only">>, Qs, {option, boolean}),
        {ResponseContent, Req1} = web_rest_callback_admin_build:get_builds(OrderBy, OrderDir, Offset, Limit, ActiveOnly, Req),

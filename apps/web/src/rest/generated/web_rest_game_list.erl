...
get_game_item_list_403(ResponseContent403) ->
    throw(#{status_code => 403, response => ResponseContent403}).

handle_get(Req) ->
    try
        {ResponseContent, Req1} = web_rest_callback_game:get_game_item_list(Req),

...
-module(web_rest_game_categories).
...
handle_get(Req) ->
    try
        {ResponseContent, Req1} = web_rest_callback_game_category:get_game_categories(Req),
        Body = jsx:encode(web_protocol:game_category_excerpt_list_to_json(ResponseContent)),

...
-module(web_rest_admin_build_publish_draft).
...
publish_draft_build_403(ResponseContent403) ->
...
handle_put(Req) ->
    try
        ...
        {ResponseContent, Req2} = web_rest_callback_admin_build:publish_draft_build(RequestContent, Id, Req1),
        Body = jsx:encode(web_protocol:build_publish_response_to_json(ResponseContent)),

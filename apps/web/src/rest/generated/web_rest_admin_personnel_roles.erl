...
-module(web_rest_admin_personnel_roles).
...
-export([
    init/2,
    get_personnel_account_roles_403/1
]).
...
get_personnel_account_roles_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_admin_personnel_roles:get_personnel_account_roles(Id, Needle, OrderBy, OrderDir, Offset, Limit, Req),

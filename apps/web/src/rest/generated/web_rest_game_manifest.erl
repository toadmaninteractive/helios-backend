...
get_game_manifest_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_game:get_game_manifest(Guid, Branch, Req),

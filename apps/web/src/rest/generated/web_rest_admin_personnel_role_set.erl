...
-module(web_rest_admin_personnel_role_set).
...
-export([
    init/2,
    set_personnel_account_role_403/1,
    reset_personnel_account_role_403/1
]).
...
set_personnel_account_role_403(ResponseContent403) ->
...
handle_put(Req) ->
    try
        ...
        {ResponseContent, Req2} = web_rest_callback_admin_personnel_roles:set_personnel_account_role(RequestContent, Id, Guid, Req1),
...
reset_personnel_account_role_403(ResponseContent403) ->
    throw(#{status_code => 403, response => ResponseContent403}).
...
handle_delete(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_admin_personnel_roles:reset_personnel_account_role(Id, Guid, Req),
        Body = jsx:encode(web_protocol:generic_response_to_json(ResponseContent)),
        ResponseHeaders = #{<<"Content-Type">> => <<"application/json; charset=utf-8">>},

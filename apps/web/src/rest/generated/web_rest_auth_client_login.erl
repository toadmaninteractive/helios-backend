...
-module(web_rest_auth_client_login).
...
handle_post(Req) ->
    try
        ...
        RequestContent = web_protocol:client_login_request_from_json(jsx:decode(RequestBody, [return_maps])),
        {ResponseContent, Req2} = web_rest_callback_client:login_client(RequestContent, Req1),
        Body = jsx:encode(web_protocol:client_login_response_to_json(ResponseContent)),

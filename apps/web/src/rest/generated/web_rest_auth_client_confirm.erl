...
-module(web_rest_auth_client_confirm).
...
handle_put(Req) ->
    try
        ...
        RequestContent = web_protocol:client_register_confirm_request_from_json(jsx:decode(RequestBody, [return_maps])),
        {ResponseContent, Req2} = web_rest_callback_client:confirm_client_registration(RequestContent, Req1),

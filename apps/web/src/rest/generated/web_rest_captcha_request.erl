...
-module(web_rest_captcha_request).
...
handle_get(Req) ->
    try
        {ResponseContent, Req1} = web_rest_callback_captcha:request_captcha(Req),
        Body = jsx:encode(web_protocol:captcha_response_to_json(ResponseContent)),

...
-module(web_rest_admin_branch_default).
...
-export([
    init/2,
    set_game_branch_as_default_403/1
]).
...
set_game_branch_as_default_403(ResponseContent403) ->
...
handle_put(Req) ->
    try
        ...
        {ResponseContent, Req2} = web_rest_callback_admin_branch:set_game_branch_as_default(RequestContent, Id, Req1),

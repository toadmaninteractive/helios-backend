...
-module(web_rest_admin_settings_ci_api_key).
...
regenerate_ci_api_key_403(ResponseContent403) ->
...
handle_put(Req) ->
    try
        ...
        {ResponseContent, Req2} = web_rest_callback_admin_settings:regenerate_ci_api_key(RequestContent, Req1),
        Body = jsx:encode(web_protocol:regenerate_ci_api_key_response_to_json(ResponseContent)),

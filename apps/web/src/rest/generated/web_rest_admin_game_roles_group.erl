...
-module(web_rest_admin_game_roles_group).
...
-export([
    init/2,
    get_personnel_group_roles_for_game_403/1
]).
...
get_personnel_group_roles_for_game_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_admin_personnel_roles:get_personnel_group_roles_for_game(Guid, Needle, OrderBy, OrderDir, Offset, Limit, Req),
        Body = jsx:encode(web_protocol:collection_slice_to_json(ResponseContent, {custom, fun web_protocol:personnel_group_role_to_json/1})),

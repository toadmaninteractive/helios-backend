...
-module(web_rest_auth_client_password_reset).
...
handle_post(Req) ->
    try
        ...
        RequestContent = web_protocol:client_password_reset_request_from_json(jsx:decode(RequestBody, [return_maps])),
        {ResponseContent, Req2} = web_rest_callback_client:reset_client_password(RequestContent, Req1),
        Body = jsx:encode(web_protocol:client_password_reset_response_to_json(ResponseContent)),

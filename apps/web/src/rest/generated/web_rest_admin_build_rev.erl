...
-module(web_rest_admin_build_rev).
...
get_build_by_rev_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_admin_build:get_build_by_rev(Guid, BuildRev, Req),

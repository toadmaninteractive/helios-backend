...
get_mobile_builds_403(ResponseContent403) ->
...
handle_get(Req) ->
    try
        ...
        OrderBy = igor_http:parse_query(<<"order_by">>, Qs, {custom, fun web_protocol:build_order_by_from_string/1}),
        ...
        {ResponseContent, Req1} = web_rest_callback_mobile:get_mobile_builds(Guid, Platform, OrderBy, OrderDir, Offset, Limit, Req),

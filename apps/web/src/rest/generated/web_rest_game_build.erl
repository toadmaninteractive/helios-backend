...
-export([
    init/2,
    get_game_build_403/1,
    get_game_build_404/1,
    get_game_build_500/1
]).
...
get_game_build_403(ResponseContent403) ->
    throw(#{status_code => 403, response => ResponseContent403}).

get_game_build_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

get_game_build_500(ResponseContent500) ->
...
handle_get(Req) ->
    try
        ...
        {ResponseContent, Req1} = web_rest_callback_game:get_game_build(Guid, BuildRev, Req),
